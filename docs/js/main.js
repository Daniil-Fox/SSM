...
(function () {
  ...
  function setBodyPadding(pad) {
    if ((0,_functions_mobile_check_js__WEBPACK_IMPORTED_MODULE_0__.mobileCheck)() === "Android" || (0,_functions_mobile_check_js__WEBPACK_IMPORTED_MODULE_0__.mobileCheck)() === "iOS") return;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  toggleContainers.forEach(container => {
    ...
    const toggleBtnTextExpand = container.dataset.toggleTextExpand || "Читать далее";
    const toggleBtnTextCollapse = container.dataset.toggleTextCollapse || "Свернуть";
    ...
    const animationDuration = parseInt(container.dataset.animationDuration) || 300; // длительность анимации
    ...
    function initMobile() {
      ...
      if (isMobile) {
        ...
        if (isTextOverflowing()) {
          ...
          toggleBtn.textContent = isExpanded ? toggleBtnTextCollapse : toggleBtnTextExpand;
        } else {
...
class FormController {
  ...
  _buildDynamicField(contactType) {
    ...
    input.className = isEmail ? "form__input input-email-dyn" : "form__input input-tel-dyn";
